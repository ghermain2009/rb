!function (n, e, t) {
    ...
    return r
            ...
            var a = n(1), s = {"%2C": ",", "%3A": ":", "%2F": "/", "%40": "@", "%24": "$", "%3B": ";"}, f = n(2), c = a(s, function (n) {
                return n
            ...
            function t(n, e) {
                if (n.info.beacon) {
                    ...
                    if (r) {
                        ...
                        i.push(h("xx", n.info.extra)), i.push(h("ua", n.info.userAttributes)), i.push(h("at", n.info.atts)), y({url: n.proto + n.info.beacon + "/" + o + "/" + n.info.licenseKey + v.fromArray(i, n.maxBytes), jsonp: w})
                    }
                }
            }
            function r(n, e) {
            ...
            function u(n, e, t, r, o) {
                ...
                return u += c(n), r && (u += v.obj(r, n.maxBytes)), o ? i = g(t) : u += v.obj(t, n.maxBytes), t.err && t.err.length && !b && (u += h("pve", "1"), b = !0), y({url: u, body: i})
            }
            function a(n) {
                ...
                for (var n = document.cookie.split(" "), e = 0; e < n.length; e++)
                    if (0 === n[e].indexOf("NREUM=")) {
                        for (var t, r, o, a, s = n[e].substring("NREUM=".length).split("&"), f = 0; f < s.length; f++)
                            0 === s[f].indexOf("s=") ? o = s[f].substring(2) : 0 === s[f].indexOf("h=") ? (o = s[f].substring(2), u.store("measures", "ph", {value: 1})) : 0 === s[f].indexOf("p=") ? (r = s[f].substring(2), ";" === r.charAt(r.length - 1) && (r = r.substr(0, r.length - 1))) : 0 === s[f].indexOf("r=") && (t = s[f].substring(2), ";" === t.charAt(t.length - 1) && (t = t.substr(0, t.length - 1)));
                        if (t) {
            ...
            var i = n(1), u = n("ee"), a = /[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g, s = {"\b": "\\b", "	": "\\t", "\n": "\\n", "\f": "\\f", "\r": "\\r", '"': '\\"', "\\": "\\\\"};
            e.exports = t
            ...
            e.exports = function () {
                ...
                function o(t) {
                    ...
                    for (var o, i, u = /^\s*at (?:((?:\[object object\])?(?:[^(]*\([^)]*\))*[^()]*(?: \[as \S+\])?) )?\(?((?:file|http|https|chrome-extension):.*?)?:(\d+)(?::(\d+))?\)?\s*$/i, a = /^\s*(?:(\S*)(?:\(.*?\))?@)?((?:file|http|https|chrome|safari-extension).*?):(\d+)(?::(\d+))?\s*$/i, s = /^\s*at .+ \(eval at \S+ \((?:(?:file|http|https):[^)]+)?\)(?:, [^:]*:\d+:\d+)?\)$/i, f = /^\s*at Function code \(Function code:\d+:\d+\)\s*/i, c = t.stack.split("\n"), l = [], d = [], m = !1, p = (/^(.*) is undefined$/.exec(t.message), 0), v = c.length; v > p; ++p) {
                        if (o = a.exec(c[p]))
                            i = {url: o[2], func: o[1] || null, line: +o[3], column: o[4] ? +o[4] : null};
                        else if (o = u.exec(c[p]))
                            i = {url: o[2], func: o[1] || null, line: +o[3], column: o[4] ? +o[4] : null}, "Anonymous function" === i.func && (i.func = null);
                        else {
                    ...
                    return l.length ? {mode: "stack", name: t.name || n(t), message: t.message, stackString: r(d.join("\n")), frames: l} : null
                }
                function i(t) {
                    for (var o, i = t.stacktrace, u = / line (\d+), column (\d+) in (?:<anonymous function: ([^>]+)>|([^\)]+))\(.*\) in (.*):\s*$/i, a = i.split("\n"), s = [], f = [], c = !1, l = 0, d = a.length; d > l; l += 2)
                        if (o = u.exec(a[l])) {
                            ...
                            f.push(a[l]);
                    return s.length ? {mode: "stacktrace", name: t.name || n(t), message: t.message, stackString: r(f.join("\n")), frames: s} : null
                }
                function u(o) {
                    ...
                    return d.length ? {mode: "multiline", name: o.name || n(o), message: i[0], stackString: r(m.join("\n")), frames: d} : null
                }
                function a(e) {
                    if (!("line"in e))
                        return null;
                    var t = e.name || n(e);
                    if (!e.sourceURL)
                        return{mode: "sourceline", name: t, message: e.message, stackString: n(e) + ": " + e.message + "\n    in evaluated code", frames: [{func: "evaluated code"}]};
                    var r = t + ": " + e.message + "\n    at " + e.sourceURL;
                    return e.line && (r += ":" + e.line, e.column && (r += ":" + e.column)), {mode: "sourceline", name: t, message: e.message, stackString: r, frames: [{url: e.sourceURL, line: e.line, column: e.column}]}
                }
                function s(e) {
                    var t = e.name || n(e);
                    return t ? {mode: "nameonly", name: t, message: e.message, stackString: t + ": " + e.message, frames: []} : null
                }
                function f(n) {
                    var e = null;
                    try {
            ...
            function t(n) {
                var e, t, r;
                for (e in n)
                    t = n[e], "number" == typeof t && t > 0 && (r = n[e] - w.offset, c({n: e, s: r, e: r, o: "document", t: "timing"}))
            }
            function r(n, e, t, r) {
            ...
            function f(n, e, t, r) {
                var o = null;
                "err" === n ? o = {n: "error", s: r.time, e: r.time, o: t.message, t: t.stackHash} : "xhr" === n && (o = {n: "Ajax", s: r.time, e: r.time + r.duration, o: t.status + " " + t.method + ": " + t.host + t.pathname, t: "ajax"}), o && c(o)
            }
            function c(n) {
                var e = A[n.n];
                e || (e = A[n.n] = []), e.push(n)
            ...
            var y = n(1), x = n(2), w = (n(3), n("loader")), b = n(5), k = n(7), E = n(6), S = "", j = {mouseup: !0, mousedown: !0}, T = {typing: 1e3, scrolling: 1e3, mousing: 1e3}, q = {typing: {keydown: !0, keyup: !0, keypress: !0}, mousing: {mousemove: !0, mouseenter: !0, mouseleave: !0, mouseover: !0, mouseout: !0}, scrolling: {scroll: !0}}, A = {}, N = n("ee");
