...
INSERT INTO `gen_estado_compra` (`id_estado_compra`, `descripcion`) VALUES
(1,	'Pendiente'),
(2,	'En Proceso'),
(3,	'Pagado'),
(4,	'Devuelto'),
...
INSERT INTO `gen_sexo` (`id_sexo`, `descripcion_sexo`) VALUES
('F',	'Femenino'),
('M',	'Masculino');
...
INSERT INTO `gen_sub_categoria` (`id_sub_categoria`, `descripcion`, `id_categoria`) VALUES
(1,	'Alisados y Laceados',	1),
(2,	'Tratamientos capilares',	1),
(3,	'Tintes y Color',	1),
(4,	'Faciales',	1),
(5,	'Maquillaje Permanente',	1),
(6,	'Peelings',	1),
(7,	'Tratamientos Corporales',	1),
(8,	'Depilación',	1),
(9,	'Masajes',	1),
(10,	'Manicure & Pedicure',	1),
(11,	'Spa',	1),
(12,	'Ecografía 4D',	1),
(13,	'Pérdida de peso',	1),
(14,	'Ginecología',	1),
(15,	'Tratamientos preventivos',	1),
(16,	'Podología',	1),
(17,	'Odontología',	1),
(18,	'Oftalmología',	1),
(19,	'Buffets',	3),
(20,	'Sushi & Makis',	3),
(21,	'Viajes Nacionales',	2),
(22,	'Viajes Internacionales',	2),
(23,	'Automotriz',	6),
(24,	'Deportes & Fitness',	5);
...
INSERT INTO `gen_tarjeta` (`id_tarjeta`, `descripcion`) VALUES
('001',	'Visa');
...
INSERT INTO `gen_tipo_documento` (`id_tipo_documento`, `descripcion`) VALUES
...
INSERT INTO `menu` (`id`, `module`, `controller`, `action`, `label`, `parent`) VALUES
(1,	'#',	'#',	'#',	'Mantenimiento',	NULL),
(2,	'dashboard',	'user',	'list',	'Usuario',	1),
(3,	'dashboard',	'role',	'list',	'Roles',	1),
(4,	'dashboard',	'campana',	'list',	'Campaña',	1),
(5,	'dashboard',	'micampana',	'index',	'Mi Campaña',	NULL),
(6,	'dashboard',	'liquidacion',	'list',	'Liquidaciones',	1),
...
INSERT INTO `privilege` (`id`, `role_id`, `menu_id`) VALUES
(1,	1,	1),
(2,	1,	2),
(3,	1,	3),
(4,	1,	4),
...
INSERT INTO `user` (`id`, `username`, `password`, `full_name`, `email`, `role_id`) VALUES
(1,	'gtapia',	'f162710ac5fb3754027223611251571ec5044227',	'Germán Tapia Rojas',	'gtapia@gibarcena.com.pe',	1),
(2,	'avilchez',	'52ae22bb8bcd8f8ebeccb3598318d6ad7cae75dc',	'Arturo Vilchez',	'avilchez@gibarcena.com.pe',	2);